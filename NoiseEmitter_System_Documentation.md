...
Usage Flow
Emission Trigger (e.g., PlayerController Update()): Call EmitRun() on movement.
...
Enemy Reaction: EnemyChase sets investigating = true, moves to noise pos, checks for player sight.
